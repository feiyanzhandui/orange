...
class FGMembersite
{
    ...
    {
        $this->sitename = 'orange';
        $this->rand_key = '0iQx5oBk66oVZep';
    }
    
    function InitDB($host,$uname,$pwd,$database,$users_tablename,$trips_tablename)
    {
        $this->db_host  = $host;
        $this->username = $uname;
        $this->pwd  = $pwd;
        $this->database  = $database;
        $this->users_tablename = $users_tablename;
        $this->trips_tablename = $trips_tablename;
    ...
    function CheckLoginInDB($username,$password)
    {
        ...
        $pwdmd5 = md5($password);
        $qry = "Select name, email from $this->users_tablename where username='$username' and password='$pwdmd5' and confirmcode='y'";
    ...
    function UpdateDBRecForConfirmation(&$user_rec)
    {
        ...
        $result = mysql_query("Select name, email from $this->users_tablename where confirmcode='$confirmcode'",$this->connection);   
        if(!$result || mysql_num_rows($result) <= 0)
        {
        ...
        $qry = "Update $this->users_tablename Set confirmcode='y' Where  confirmcode='$confirmcode'";
    ...
    function ChangePasswordInDB($user_rec, $newpwd)
    {
        ...
        $qry = "Update $this->users_tablename Set password='".md5($newpwd)."' Where  id_user=".$user_rec['id_user']."";
    ...
    function GetUserFromEmail($email,&$user_rec)
    {
        ...
        $result = mysql_query("Select * from $this->users_tablename where email='$email'",$this->connection);  
    ...
    function IsFieldUnique($formvars,$fieldname)
    {
        ...
        $qry = "select username from $this->users_tablename where $fieldname='".$field_val."'";
        $result = mysql_query($qry,$this->connection);   
        if($result && mysql_num_rows($result) > 0)
        {
            return false;
    ...
    {
        $result = mysql_query("SHOW COLUMNS FROM $this->users_tablename");   
        if(!$result || mysql_num_rows($result) <= 0)
        {
    ...
    {
        $qry = "Create Table $this->users_tablename (".
    ...
    function InsertIntoDB(&$formvars)
    {
        ...
        $insert_query = 'insert into '.$this->users_tablename.'(
                name,
                email,
                username,
                password,
