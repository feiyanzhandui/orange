...
{
  if($fgmembersite->RegisterSearchResult(htmlspecialchars($_POST['departure']), htmlspecialchars($_POST['arrive']), htmlspecialchars($_POST['ddate']))) {
     ...
     <div class="header">  
       ...
       <div class="top-menu">
        ...
        <ul class="cl-effect-1">
           ...
           <li><a href="login-home.php">Hello, <?= $fgmembersite->UserFullName() ?>!</a></li>
